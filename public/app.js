...
React.render(React.createElement(DominionClient, null), mountNode);
...
},{"./react/dominionClient.jsx":160,"./socket":161,"react":156}],158:[function(require,module,exports){
...
var DominionClient = React.createClass({displayName: "DominionClient",
  render: function() {
    return (React.createElement("div", {className: "hi"}, "test"));
  }
});
...
},{"./event-emitter":158,"./inherits":159}]},{},[157]);
